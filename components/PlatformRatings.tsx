const platforms = [
  { name: 'Google',    color: 'text-blue-600',   rating: '4.9', count: '500+' },
  { name: 'Sulekha',  color: 'text-green-600',  rating: '4.8', count: '300+' },
  { name: 'JustDial', color: 'text-orange-600', rating: '4.9', count: '400+' },
  { name: 'Indiamart',color: 'text-blue-800',   rating: '4.7', count: '200+' },
]
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-5">
          {platforms.map((p) => (
            ...
            >
              ...
              <div className={`font-cinzel font-bold text-lg sm:text-xl ${p.color}`}>{p.name}</div>
